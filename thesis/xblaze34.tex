...
\projectinfo{
  ...
  title.cs={Statistické ověřování modelů přibližných výpočetních systémů},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Statistical Model Checking of Approximate Computing Systems}, % název práce v angličtině / thesis title in english
  ...
  keywords.cs={modelování, simulace, aproximace, formální verifikace, statistické ověřování modelů, násobičky, aproximační násobičky, stochastické časové automaty, UPPAAL, Python}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={modelling, simulation, approximation, formal verification, statistical model checking, multipliers, approximate multipliers, stochastic timed automata, UPPAAL, Python}, % klíčová slova v anglickém jazyce / keywords in english
...
% I have listed all the literary sources, publications and other sources, which were used during the preparation of this thesis.},
  ...
  acknowledgment={Rád bych poděkoval vedoucímu práce panu Ing. Josefu Strnadelovi, Ph.D. za zadání zajímávého tématu a následnou pomoc a cenné rady při jeho řešení. Dále bych chtěl poděkovat své rodině a přátelům za jejich neutuchající podporu v průběhu celého studia.},
